...
class GUserUi {
    ...
    public function run() {
        ...
        //
        echo sprintf("<button class='user10' type='button' onclick='callServer(\"new\")'>Nouveau</button>\n");
        echo sprintf("<button class='user10' type='button' name='action' value='delete'>Supprimer</button>\n");
        echo sprintf("<button class='user10' type='button' name='action' value='search'>Rechercher</button>\n");
        echo sprintf("<button class='user10' type='button' name='action' value='save'>Enregistrer</button>\n");
        //
        echo sprintf("</div>\n");
        echo sprintf("</div>\n");
        //
